<form @if($new_despacho) wire:submit="save" @else wire:submit="update" @endif xmlns:wire="http://www.w3.org/1999/xhtml">
                        ...
                        <div class="row table-responsive p-0">
                            ...
                            <table class="table">
                                ...
                                @for($i = 0; $i < $contador; $i++)
                                    @include('dashboard.despachos.from_detalles')
                                @endfor
                                </tbody>
                            </table>
...
@include('dashboard.despachos.modal_buscar')
